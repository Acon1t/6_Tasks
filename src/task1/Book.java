...
public class Book {
    ...
    public Book(String name, String author, String format, int year, String genre, String description, String location) {
        this.name = name;
        this.author = author;
        this.format = format;
        this.year = year;
    ...
    public void add(String name, String author, String format, String year, String genre, String description, String location)
            throws Exception {
        FileWriter nFile = new FileWriter("src\\task1\\resources\\Books.txt", true);
